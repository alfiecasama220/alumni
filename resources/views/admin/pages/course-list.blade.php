        ...
        <div class="col-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-description"> Insert a new course </p>
              <form class="forms-sample" action="{{ route('course.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <label class="text-light" for="exampleInputName1">Course name</label>
                  <input type="text" class="form-control" name="course" id="exampleInputName1" placeholder="Course name here">
                </div>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="table-responsive">
                  ...
                  <div>{{ $course->links('pagination::bootstrap-5') }}</div>
