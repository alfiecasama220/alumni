...
<div class="main-content-area">
  ...
  <section>
    <div class="w-100 d-flex justify-content-end mt-5">
      <button type="button" class="btn btn-outline-theme-colored1 btn-round btn-sm mr-5" data-toggle="modal" data-target="#exampleModalCenter">Add Forums  <i class="fa fa-angle-double-right"></i></button>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalCenterTitle">Add Forums</h5>
            ...
            <div class="modal-body">
              <div class="border-1px p-25">
                ...
                <form id="appointment_form" name="appointment_form" class="mt-30" method="POST" action="{{ route('forums.store') }}">
                  @csrf
                  <div class="row">
                    <div class="col-sm-12">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-2 d-flex align-items-center">
                    <div class="event-count p-15 mt-15">
                      <div class="">
                        <a href="{{ route('forums.show', $forum->id) }}" class="btn btn-outline-theme-colored1 btn-round btn-sm">Details <i class="fa fa-angle-double-right"></i></a>
                      </div>
